...
function SignUp() {
    ...
    useEffect(() => {
        // Update the address field when the 'add' value from the context changes
                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col justify-center items-center gap-8">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" name="dob" value={formData.dob} onChange={handleChange} placeholder="Type here" className="input input-bordered w-full max-w-xs" />
                            <div className="label">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" name="email" value={formData.email} onChange={handleChange} placeholder="Type here" className="input input-bordered w-full max-w-xs" />
                        </label>
                        <label className="form-control w-full max-w-xs">
                            <div className="label">
                            ...
                            <div className="flex flex-row">
                                ...
                                <input type="text" name="phoneno" placeholder="1234567890" className="input input-bordered w-full max-w-xs" value={formData.phone} onChange={handleChange} />
                            </div>
                            <div className="label">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <select name="nationality" value={formData.nationality} onChange={handleChange} className="select border-slate-300 w-full max-w-xs text-xl">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="text" name="address" value={formData.address} onChange={handleChange} placeholder="Address" className="input input-bordered w-full max-w-xs" />
                            <div className="pt-4">
                                <NavLink
                                    to="../location">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <select className="select border-slate-300 w-full max-w-xs text-xl" value={formData.gender} onChange={handleChange} name="gender">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Type here" className="input input-bordered w-full max-w-xs" />
                            <div className="label">
